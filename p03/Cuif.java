...
public class Cuif {
    ...
    byte[] cuiffile; //  o array de bytes com dados do arquivo em memria
    ...
    // Durante a leitura, o mtodo tambm salva no array de bytes cuiffile que representa os dados do arquivo cuif
